...
public class PharmanetRoute extends BaseRoute {
	...
	public void configure() throws Exception {
		...
		from("direct:pharmanet").routeId("pharmanet-route")
	    	.log(LoggingLevel.DEBUG, "Message identified as PharmaNet message. Preparing message for PharmaNet.")
	        ...
	        .log(LoggingLevel.DEBUG, "Sending to Pharmanet")
	        ...
	        .log(LoggingLevel.DEBUG, "Received response from Pharmanet:${headers}")
	        .to("log:HttpLogger?level=DEBUG&showBody=true&showHeaders=true&multiline=true")
