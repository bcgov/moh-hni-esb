...
public class UtilTest {
	...
	@Test
	public void testConvertStringToHex_msgControlIdIsBlank() {
		String hexa = Util.convertStringToHex(null);
		assertEquals(48,hexa.length());
	}
	
	@Test
	public void testConvertStringToHex_forLength_whenMgCntrlIdIsNotBlank() {
	...
	@Test
	public void testConvertStringToHex_whenMgCntrlIdIsNotBlank() {
		String hexaString = Util.convertStringToHex("20210831112325");
